...
import net.codeus.android.DateSlider.Labeler;
import net.codeus.android.DateSlider.TimeObject;
...
public class DayMonthYearDateSlider extends DateSlider {

	public DayMonthYearDateSlider(Context context, OnDateSetListener l, Calendar calendar) {
