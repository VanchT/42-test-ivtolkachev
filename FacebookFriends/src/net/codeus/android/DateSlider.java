...
//	private static String TAG = "DATESLIDER";
	...
	public abstract class Labeler {		
		 ...
		 * @return 
		 */
		public TimeTextView createView(Context context, boolean isCenterView) {
			return new TimeTextView(context, isCenterView);
		}
	 ...
	 *
	 */
	public static class TimeTextView extends TextView {
		public long startTime, endTime;
		public TimeTextView(Context context, boolean isCenterView) {
			super(context);
			setupView(isCenterView);
		}
		 ...
		 * @param isCenterView
		 */
		protected void setupView(boolean isCenterView) {
		...
		public void setVals(TimeTextView other) {
